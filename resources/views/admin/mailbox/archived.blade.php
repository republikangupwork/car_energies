            	...
            	<div class="col-md-10">
              		<div class="card">
                		<div class="card-header card-header-info">
                  			<h3 class="card-title inbox-title">Trash</h3>
                		</div>
                		<div class="card-body" style="min-height: 400px;">
							...
							@else 
								<h3 class="text-center" style="font-size: 5vh;">Nothing in Trash Messages <i class="far fa-folder-open"></i></h3>
							@endif
                		</div>
                	</div>
                </div>
...
<script>
	$(document).ready(function() {
		$('.trash tbody tr').on('click', function() {
			// alert($('#id').val())
		})
	})
</script>
