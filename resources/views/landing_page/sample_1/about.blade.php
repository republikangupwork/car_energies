            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center mb-3">
                            <h2 data-aos="fade-right" class="lg-title mb-2 section-title"><span style="font-weight: bold;"  class="color-green">About</span> <span class="color-white bg-green px-3">Car energies</span><span class="ml-1 color-green">& julia</span></h2>
                    </div>
                </div>
                <div class="col-md-8 offset-md-2 row mb-5">
                       <p class="section-description">Julia B. is very sensitive to subtle energies of objects, animals and people. She consumes energy doing this evaluation. She can evaluate a maximum of 100 automobiles a day. And for now, she will check up to 3 cars per person free of charge (and no more). Please note that this is for your personal use, and there are no guarantees that the car she approves, will be completely trouble free. But she has a proven track record of being %95 accurate in her evaluation..</p>
                </div>
                ...
                <div class="row mb-5 py-5 bg-light">
                    ...
                    <div class="col-md-6">
                        <p class="section-description">Julia can spot the troubles, accidents, damaged auto parts on cars, automobiles, trucks, motorcycles even bicycles. Even the best mechanics with the latest technologies who can check  a used car and give you a report of list of possible repairs can not detect the parts that are working at the moment of examination, but are done, used up and ready and about to break at any moment.</p >
                    </div>
                </div>
                   <div class="row ">
                <div class="col-lg-12 ">
                    <div class="container mb-5">
                        <p class="px-5 text-center color-black" style="font-size: 30px">Where else can someone look at the photos of a car and see the failed arts, hidden problems, covered up headaches?</p>
                    </div>
