...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' https://geodata.solutions/api/api.php?type=getCountries&addClasses=form-control%2Ccountries gap:; script-src 'self' data: https://ssl.gstatic.com 'unsafe-inline' 'unsafe-eval'; object-src *; style-src 'self' data: 'unsafe-inline'; img-src 'self' data:; media-src 'self' data:; font-src 'self' data:; connect-src *">
