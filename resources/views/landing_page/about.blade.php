            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-1">
                         <div class="about-img">
                        <img src="{{ asset('images/sample_1/about/julia.jpg') }}" alt="" class="img-fluid" height="500" width="600">
                    </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row col-lg-12 justify-content-center">
                    <a href="{{ url('submit/') }}" class="btn btn-success text-center font-30">TRY OUR SERVICE FOR FREE</a>
                </div>  
